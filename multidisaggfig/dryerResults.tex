\begin{figure*}[!t]
        \centering{
                \begin{tabular}{cccc}
                \includegraphics[width=0.4\textwidth]{multidisaggfig/dryerPhase12OnDiff.png} &
                \includegraphics[width=0.4\textwidth]{multidisaggfig/waterHeaterPhase12OnDiff.png} \tabularnewline
                (a) & (b) \tabularnewline
                \includegraphics[width=0.4\textwidth]{multidisaggfig/heatingIndoorOutdoorPhase12On_1.png}&
                \includegraphics[width=0.4\textwidth]{multidisaggfig/UpToiletFitted.png}\tabularnewline
                (c) & (d) \tabularnewline
                \end{tabular}
                }
        \caption{
